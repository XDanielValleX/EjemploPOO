...
import co.edu.unicolombo.poo.GUI.User.VentanaRolCrud;
...
public class VentanaMaster extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        menuRoles.add(jMenuItem1);

        jMenuItem2.setText("Buscar");
        menuRoles.add(jMenuItem2);
    ...
    private void jMenuItem1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem1ActionPerformed
        VentanaRolCrud vent = new VentanaRolCrud(this, true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VentanaMaster.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VentanaMaster().setVisible(true);
            }
        });
    }
